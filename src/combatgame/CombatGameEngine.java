...
public class CombatGameEngine
{
     ...
     * @param enemies A list of enemies for the player to fight, in order of appearance.
     */
    ...
    /**
     * Run the combat game represented by this engine. This method will not
     * return until the player either defeats all of the enemies, or dies.
     */
    public void run()
    {
